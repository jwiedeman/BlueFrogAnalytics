...
func main() {
    ...
    cluster.ConnectTimeout       = 30 * time.Second   // dial + auth
    cluster.Timeout              = 5 * time.Minute    // default per-query timeout
    cluster.WriteTimeout         = 5 * time.Minute    // for batch/insert/write calls

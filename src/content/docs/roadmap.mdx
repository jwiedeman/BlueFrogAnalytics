---
title: Blue Frog Analytics Roadmap
description: High-level project roadmap for Blue Frog Analytics featuring core capabilities, status indicators, and a 2-month MVP timeline.
template: splash
hero:
  tagline: |
...
[Get Started Now](/introduction/how-blue-frog-analytics-works)

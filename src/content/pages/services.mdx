...
<section class="carbon-hero nasa-hero">
  ...
  <button data-modal-target="#blueprint-modal" class="bx--btn bx--btn--primary nasa-btn">Claim Your Complimentary Growth Blueprint</button>
</section>
...
<section>
<table class="bx--data-table bx--data-table--compact nasa-table">
  <thead>
...
<ul class="bx--progress nasa-progress">
...
<div data-modal id="blueprint-modal" class="bx--modal nasa-modal" tabindex="-1" role="dialog">
  <div class="bx--modal-container">
    ...
    <div class="bx--modal-content">
      ...
      <a href="/community/contact/" class="bx--btn bx--btn--primary nasa-btn">Contact Us</a>
    </div>

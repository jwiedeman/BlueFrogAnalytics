  ...
  <div className="row">
    <div className="col-12">
      ...
      <div className="row g-4">
        ...
        <div className="col-sm-6 col-lg-4"><h3 className="h5">Quality Assurance &amp; Compliance</h3><p>Service Info</p></div>
        <div className="col-sm-6 col-lg-4"><h3 className="h5">Growth &amp; Optimization</h3><p>Service Info</p></div>
        <div className="col-sm-6 col-lg-4"><h3 className="h5">Training &amp; Enablement</h3><p>Service Info</p></div>
        <div className="col-sm-6 col-lg-4"><h3 className="h5">Innovation &amp; R&amp;D</h3><p>Service Info</p></div>
        <div className="col-sm-6 col-lg-4"><h3 className="h5">Brand Influence &amp; Propaganda</h3><p>Service Info</p></div>
        <div className="col-sm-6 col-lg-4"><h3 className="h5">Creative Direction &amp; Coordination</h3><p>Service Info</p></div>
      </div>

  ...
  <div class="row justify-content-center">
    <div class="col-lg-8">
      ...
      <div id="filter-container" class="mb-3">
        <label for="column-select" class="form-label">Analytics columns</label>
        <select id="column-select" multiple class="form-select mb-2" size="4"></select>
        <div class="btn-group" role="group">
          <button id="select-all" type="button" class="btn btn-secondary">Select All</button>
          <button id="clear-all" type="button" class="btn btn-outline-secondary">Clear</button>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-12">
      <div id="table-wrapper" class="table-responsive">
        <table id="pages-table" class="table table-striped table-bordered table-sm">
          <thead>
